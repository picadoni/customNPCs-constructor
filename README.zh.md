...
**对话生成器 "The Great" (v1.0) / 任务生成器 "牧师" (v0.5)/ 脚本模块 "Cosmos" (v0.5)**
...
**对话生成器 "The Great" (v1.0) / 任务生成器 "Secretary" (v0.6) / 脚本模块 "Servant" (v0.6)**
*（对话和任务生成器未获得新名称，因为其功能在此版本中未作更新）。*
* **错误修复：** 彻底解决了本地化错误。标签页标题现在可以根据所选语言正确显示。

### [1.6 版本](https://picadoni.github.io/customNPCs-constructor/ver%201.6/)
...
* ### [1.7 版本 (当前)](https://picadoni.github.io/customNPCs-constructor)
**对话生成器 "森林" (v1.1) / 任务生成器 "Secretary" (v0.7) / 脚本模块 "观察者" (v0.8)**
*（任务编辑器由于在此版本中未进行功能更新，因此未获得新名称）。*
* **新功能：** 对话现已署名，且对话标题可见。脚本模块中新增了一个用于预览特效的微型播放器。
* **缺陷修复：** 修复了无法运行的脚本，用于自动生成的模板现在可以正常工作。
* **优化改进：** 齿轮图标已更换为更时尚的样式。
